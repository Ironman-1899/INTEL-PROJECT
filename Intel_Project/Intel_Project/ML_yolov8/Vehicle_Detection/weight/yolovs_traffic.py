...
model = YOLO('/home/raspberry/Intel_Project/ML_yolov8/Vehicle_Detection/weight/yolov8s.pt')
my_file = open("/home/raspberry/Intel_Project/ML_yolov8/Vehicle_Detection/weight/coco.txt", "r")
data = my_file.read()
