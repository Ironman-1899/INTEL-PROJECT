...
np_model = YOLO('ML_yolov8/Vehicle_number_plate_detection/weight/license_plate_detector_best_zoom.pt')

# read in test video paths
videos = glob('/home/raspberry/Intel_Project/ML_yolov8/Vehicle_number_plate_detection/weight/vehicle_license_plate_video.mp4')
print(videos)
